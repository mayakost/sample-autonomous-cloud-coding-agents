...
6. **Jira** - Add a label to a Jira Cloud issue to trigger a task; the agent posts progress comments back on the issue via the Jira REST API. See the [Jira setup guide](./JIRA_SETUP_GUIDE.md).
