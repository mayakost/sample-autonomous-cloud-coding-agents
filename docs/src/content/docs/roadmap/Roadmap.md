...
- [x] **Jira integration** - Label-triggered tasks on Jira Cloud, `bgagent jira setup` / `map` / `link`, progress comments via the Jira REST API ([ADR-015](/architecture/adr-015-jira-integration)). See [JIRA_SETUP_GUIDE.md](/using/jira-setup-guide)
